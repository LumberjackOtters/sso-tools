<template>
  <v-container>
    ...
    <p>This policy is designed to be accessible, understandable, and easy to read without legal and other jargon. If you have any comments, questions, or concerns about this policy, please get in touch with us by emailing hello@sso.tools.</p>
    <p>This document will have slight changes made to it occasionally. Please refer back to it from time to time.</p>
    <p>This policy governs the use and protection of personal data of people (‘users’, ‘you’, etc.) using SSO Tools.</p>
    ...
    <h2>What data does SSO Tools collect?</h2>
    ...
    <h3>When signing-up for a SSO Tools account</h3>
    <p>SSO Tools allows you to register for an account. This is the primary way by which we collect personal data from you, since such data is needed in order to identify you when you want to login and use these services. We may also use your email address to update you on platform updates and notifications, which you can control. When signing-up we may collect an email address, username, and password. Once registered, you can choose to fill in additional profile data, such as social media links, a bio, and more. We ask for consent to this policy when creating an account, and the legal basis for processing this data is a legitimate interest in being able to provide services to you.</p>

    <h3>When using SSO Tools</h3>
    <p>Content and any other data you add to or upload to SSO Tools as part of its standard use are also collected. This is for the purposes of providing services to you. To use SSO Tools, you will have provided consent to this policy during the registration process, and the legal basis for processing this data is a legitimate interest in being able to provide core services to you.</p>

    <h2>Who has access to your data?</h2>
    <p>Staff operating SSO Tools can view accounts and account data. This is with the exception of passwords, which are fully encrypted.</p>
    ...
    <p>We keep your account data (email and/or username) and content produced by your account (e.g. content, projects) for as long as your account is active. You can fully and irreversibly delete your account (and its associated data) at any time. Please note that data held in backup systems may be held for up to 30 days after such an event before it too is deleted.</p>
    ...
    <h2>Child safety</h2>
    <p>Children under the age of 16 are not allowed to use SSO Tools or to directly provide us with personal data. As such, we do not knowingly store or process personal data relating to children under the age of 16.</p>
